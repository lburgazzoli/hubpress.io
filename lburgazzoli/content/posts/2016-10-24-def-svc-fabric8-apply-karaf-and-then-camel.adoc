...
date: 2016-10-24
draft: true
tags: [microservices, fabric8, karaf, camel, openshift, kubernetes]
---
...
IMPORTANT: If you deploy on OpenShift you need to grant view role to the service account `oc policy add-role-to-user view system:serviceaccount:$(oc project -q):default -n $(oc project -q)`
